...
![Алгоритм Шора. Квантовая часть](Алгоритм_Шора.jpg):
...
Предположим, что мы можем сформировать состояние квантового регистра по правилу **SUM SQRT(f(x))|x>** \
...
![Схема алгоритма поиска периода с использованием свёртки](Алгоритм_свёртки.jpg)
